...
# static fields
.field public static final Companion:LR3/l;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LR3/n;->Companion:LR3/l;
    ...
    sput-object v1, LR3/n;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, LR3/n;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
...
.method public constructor <init>(IZ)V
    ...
    iput p2, p0, LR3/n;->c:I

    new-instance v0, Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-direct {v0, p1}, Ljava/util/concurrent/atomic/AtomicReferenceArray;-><init>(I)V

    iput-object v0, p0, LR3/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final a(Ljava/lang/Runnable;)I
    ...
    :cond_0
    sget-object v0, LR3/n;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    sget-object p1, LR3/n;->Companion:LR3/l;
    ...
    :cond_2
    iget-object v11, p0, LR3/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-boolean v4, p0, LR3/n;->b:Z
    ...
    sget-object v4, LR3/n;->Companion:LR3/l;
    ...
    invoke-virtual {v1}, LR3/n;->c()LR3/n;

    move-result-object v1

    iget-object v2, v1, LR3/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v3, v1, LR3/n;->c:I
...
.method public final c()LR3/n;
    ...
    :goto_0
    sget-object v4, LR3/n;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    iget v6, v1, LR3/n;->a:I

    mul-int/lit8 v6, v6, 0x2

    iget-boolean v7, v1, LR3/n;->b:Z

    invoke-direct {v5, v6, v7}, LR3/n;-><init>(IZ)V
    ...
    iget-object v8, v1, LR3/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    invoke-direct {v8, v6}, LR3/m;-><init>(I)V

    :cond_3
    iget-object v9, v5, LR3/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v10, v5, LR3/n;->c:I
    ...
    :cond_4
    sget-object v6, LR3/n;->Companion:LR3/l;
...
.method public final d()Ljava/lang/Object;
    ...
    :cond_2
    iget-object v14, v1, LR3/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-virtual {v14, v12}, Ljava/util/concurrent/atomic/AtomicReferenceArray;->get(I)Ljava/lang/Object;

    move-result-object v15

    iget-boolean v5, v1, LR3/n;->b:Z
    ...
    :cond_7
    sget-object v3, LR3/n;->Companion:LR3/l;
    ...
    iget-object v0, v1, LR3/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v1, v1, LR3/n;->c:I
