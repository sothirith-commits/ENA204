...
.method public static o(Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {v1, p1, v0}, Ly3/m;->z(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    :try_end_0
...
.method public static p(Ljava/io/File;Ljava/io/File;)V
    ...
    :try_start_1
    invoke-static {v0, p0}, Lt0/a;->f(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_1
    ...
    invoke-direct {p1, p0, v0}, Ly3/a;-><init>(Ljava/io/File;I)V
...
.method public static q(Ljava/io/File;)Z
    ...
    sget-object v0, Ly3/l;->BOTTOM_UP:Ly3/l;
    ...
    invoke-direct {v1, p0, v0, v2}, Ly3/k;-><init>(Ljava/io/File;Ly3/l;Lf2/k;)V

    new-instance p0, Ly3/i;

    invoke-direct {p0, v1}, Ly3/i;-><init>(Ly3/k;)V
    ...
    invoke-virtual {p0}, Lo3/b;->next()Ljava/lang/Object;
...
.method public static r(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, LJ3/r;->Y0(Ljava/lang/String;CLjava/lang/String;)Ljava/lang/String;
...
.method public static final s(Ly3/c;)Ly3/c;
    .locals 6

    new-instance v0, Ly3/c;

    iget-object v1, p0, Ly3/c;->a:Ljava/io/File;

    new-instance v2, Ljava/util/ArrayList;

    iget-object p0, p0, Ly3/c;->b:Ljava/lang/Object;
    ...
    :cond_3
    invoke-direct {v0, v1, v2}, Ly3/c;-><init>(Ljava/io/File;Ljava/util/List;)V
...
.method public static t(Ljava/io/File;)[B
    ...
    invoke-static {v0, v6}, Lt0/a;->f(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    invoke-static {v1, v3, v4, p0, v2}, Lo3/p;->a0(III[B[B)V
    :try_end_2
...
.method public static u(Ljava/io/File;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v1}, Lt0/a;->m(Ljava/io/Reader;)Ljava/lang/String;
...
.method public static v(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1}, Ls4/b;->l(Ljava/lang/String;)I
    ...
    invoke-static {p0, p1}, LJ3/r;->B0(Ljava/lang/String;C)Z
...
.method public static final w(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    .locals 10
    ...
    invoke-static {p0}, Ls4/b;->n(Ljava/io/File;)Ly3/c;

    move-result-object v0

    invoke-static {v0}, Ly3/m;->s(Ly3/c;)Ly3/c;

    move-result-object v0

    invoke-static {p1}, Ls4/b;->n(Ljava/io/File;)Ly3/c;

    move-result-object v1

    invoke-static {v1}, Ly3/m;->s(Ly3/c;)Ly3/c;

    move-result-object v1

    iget-object v2, v0, Ly3/c;->a:Ljava/io/File;

    iget-object v3, v1, Ly3/c;->a:Ljava/io/File;
    ...
    :cond_0
    iget-object v1, v1, Ly3/c;->b:Ljava/lang/Object;
    ...
    :cond_5
    invoke-static {v0, v6}, Lo3/q;->B0(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    invoke-static {v0, v5, v1, v3, v2}, Lo3/q;->J0(Ljava/util/List;Ljava/lang/StringBuilder;Ljava/lang/String;LB/W;I)V
