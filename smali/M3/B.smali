...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v1}, LM3/P;->J(Z)V
...
.method public final I()Ljava/lang/Thread;
    ...
    sget-object v0, LM3/B;->_thread:Ljava/lang/Thread;
    ...
    sput-object v0, LM3/B;->_thread:Ljava/lang/Thread;

    sget-object v1, LM3/B;->o:LM3/B;
...
.method public final M(JLM3/M;)V
    .locals 0
...
.method public final N()V
    ...
    sput v0, LM3/B;->debugStatus:I

    invoke-super {p0}, LM3/O;->N()V
...
.method public final O(Ljava/lang/Runnable;)V
    ...
    sget v0, LM3/B;->debugStatus:I

    const/4 v1, 0x4

    if-eq v0, v1, :cond_0

    invoke-super {p0, p1}, LM3/O;->O(Ljava/lang/Runnable;)V
...
.method public final run()V
    ...
    sput-object v2, LM3/B;->_thread:Ljava/lang/Thread;

    invoke-virtual {v1}, LM3/B;->T()V

    invoke-virtual {v1}, LM3/O;->R()Z

    move-result v0

    if-nez v0, :cond_a

    invoke-virtual {v1}, LM3/B;->I()Ljava/lang/Thread;

    return-void

    :cond_2
    :try_start_3
    sput v6, LM3/B;->debugStatus:I
...
.method public final v(JLM3/s0;Lr3/h;)LM3/H;
    ...
    new-instance p4, LM3/L;

    add-long/2addr v0, p1

    invoke-direct {p4, v0, v1, p3}, LM3/L;-><init>(JLM3/s0;)V

    invoke-virtual {p0, p1, p2, p4}, LM3/O;->S(JLM3/M;)V
