.class public Lorg/maplibre/android/gestures/ShoveGestureDetector;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/maplibre/android/gestures/ShoveGestureDetector$SimpleOnShoveGestureListener;,
        Lorg/maplibre/android/gestures/ShoveGestureDetector$OnShoveGestureListener;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->handledTypes:Ljava/util/Set;
...
.method public analyzeMovement()Z
    ...
    invoke-virtual {p0}, Lorg/maplibre/android/gestures/ShoveGestureDetector;->calculateDeltaPixelsSinceLast()F

    move-result v0

    iput v0, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->deltaPixelSinceLast:F

    iget v1, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->deltaPixelsSinceStart:F

    add-float/2addr v1, v0

    iput v1, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->deltaPixelsSinceStart:F
    ...
    iget v0, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->deltaPixelSinceLast:F
    ...
    check-cast v1, Lorg/maplibre/android/gestures/ShoveGestureDetector$OnShoveGestureListener;

    iget v2, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->deltaPixelsSinceStart:F

    invoke-interface {v1, p0, v0, v2}, Lorg/maplibre/android/gestures/ShoveGestureDetector$OnShoveGestureListener;->onShove(Lorg/maplibre/android/gestures/ShoveGestureDetector;FF)Z
    ...
    invoke-virtual {p0, v0}, Lorg/maplibre/android/gestures/ShoveGestureDetector;->canExecute(I)Z
    ...
    check-cast v0, Lorg/maplibre/android/gestures/ShoveGestureDetector$OnShoveGestureListener;

    invoke-interface {v0, p0}, Lorg/maplibre/android/gestures/ShoveGestureDetector$OnShoveGestureListener;->onShoveBegin(Lorg/maplibre/android/gestures/ShoveGestureDetector;)Z
...
.method public canExecute(I)Z
    ...
    iget v0, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->deltaPixelsSinceStart:F

    invoke-static {v0}, Ljava/lang/Math;->abs(F)F

    move-result v0

    iget v1, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->pixelDeltaThreshold:F
...
.method public gestureStopped()V
    ...
    invoke-interface {v0, p0, v1, v2}, Lorg/maplibre/android/gestures/ShoveGestureDetector$OnShoveGestureListener;->onShoveEnd(Lorg/maplibre/android/gestures/ShoveGestureDetector;FF)V
...
.method public getMaxShoveAngle()F
    ...
    iget v0, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->maxShoveAngle:F
...
.method public getPixelDeltaThreshold()F
    ...
    iget v0, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->pixelDeltaThreshold:F
...
.method public isAngleAcceptable()Z
    ...
    iget v2, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->maxShoveAngle:F
...
.method public isSloppyGesture()Z
    ...
    invoke-virtual {p0}, Lorg/maplibre/android/gestures/ShoveGestureDetector;->isAngleAcceptable()Z
...
.method public provideHandledTypes()Ljava/util/Set;
    ...
    sget-object v0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->handledTypes:Ljava/util/Set;
...
.method public reset()V
    ...
    iput v0, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->deltaPixelsSinceStart:F
...
.method public setMaxShoveAngle(F)V
    ...
    iput p1, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->maxShoveAngle:F
...
.method public setPixelDeltaThreshold(F)V
    ...
    iput p1, p0, Lorg/maplibre/android/gestures/ShoveGestureDetector;->pixelDeltaThreshold:F
...
.method public setPixelDeltaThresholdResource(I)V
    ...
    invoke-virtual {p0, p1}, Lorg/maplibre/android/gestures/ShoveGestureDetector;->setPixelDeltaThreshold(F)V
