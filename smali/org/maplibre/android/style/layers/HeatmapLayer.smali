...
.method public getHeatmapColor()Lorg/maplibre/android/style/layers/PropertyValue;
    .locals 3
...
.method public getHeatmapColorAsInt()I
    ...
    invoke-virtual {p0}, Lorg/maplibre/android/style/layers/HeatmapLayer;->getHeatmapColor()Lorg/maplibre/android/style/layers/PropertyValue;
...
.method public getHeatmapIntensity()Lorg/maplibre/android/style/layers/PropertyValue;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getHeatmapIntensityTransition()Lorg/maplibre/android/style/layers/TransitionOptions;
    .locals 1
...
.method public getHeatmapOpacity()Lorg/maplibre/android/style/layers/PropertyValue;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getHeatmapOpacityTransition()Lorg/maplibre/android/style/layers/TransitionOptions;
    .locals 1
...
.method public getHeatmapRadius()Lorg/maplibre/android/style/layers/PropertyValue;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getHeatmapRadiusTransition()Lorg/maplibre/android/style/layers/TransitionOptions;
    .locals 1
...
.method public getHeatmapWeight()Lorg/maplibre/android/style/layers/PropertyValue;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public setHeatmapIntensityTransition(Lorg/maplibre/android/style/layers/TransitionOptions;)V
    .locals 4
...
.method public setHeatmapOpacityTransition(Lorg/maplibre/android/style/layers/TransitionOptions;)V
    .locals 4
...
.method public setHeatmapRadiusTransition(Lorg/maplibre/android/style/layers/TransitionOptions;)V
    .locals 4
...
.method public withFilter(Lorg/maplibre/android/style/expressions/Expression;)Lorg/maplibre/android/style/layers/HeatmapLayer;
    .locals 0

    invoke-virtual {p0, p1}, Lorg/maplibre/android/style/layers/HeatmapLayer;->setFilter(Lorg/maplibre/android/style/expressions/Expression;)V

    return-object p0
.end method

.method public varargs withProperties([Lorg/maplibre/android/style/layers/PropertyValue;)Lorg/maplibre/android/style/layers/HeatmapLayer;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
...
.method public withSourceLayer(Ljava/lang/String;)Lorg/maplibre/android/style/layers/HeatmapLayer;
    .locals 0

    invoke-virtual {p0, p1}, Lorg/maplibre/android/style/layers/HeatmapLayer;->setSourceLayer(Ljava/lang/String;)V
